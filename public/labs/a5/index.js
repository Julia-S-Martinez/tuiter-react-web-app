...
console.log(fourIndex, string3Index);
...
const oddNumbers = numberArray1
    .filter(a => a % 2 !== 0);
console.log(numbersGreaterThan2, evenNumbers, oddNumbers);
...
const init = () => {
    ...
    showMe.show();const newLineItem = $("<li>Line item 1</li>");
